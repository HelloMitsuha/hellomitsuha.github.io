...
gg.alert("源码已公开,链接:https://raw.githubusercontent.com/jiangyuxian/luas/main/yux.lua\n\n现已分享源码给QQ2372272305,请永远相信江玉仙制作的是正版~")

--gg.alert("警告!本辅助已添加反log拦截功能,如果使用时出现问题请下载源码,并删除log检测函数(YsearchNumber),并全部替换为gg.searchNumber再运行!")
...
if mm[2] == true then
  log = false
  gg.alert("🌸由于精准日志在测试中导致仿xs出错，因此正在维护🌸")
end
new=mm[3]
gg.toast("🌸当前迷你号:" .. a .. "好耶!让我们一起炸图吧!🍭️o(≧v≦)o💣🌸")
--迷你号配置--
